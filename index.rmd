...
_I am currently looking for positions for after I graduate (~Sep 2020). Get in touch if you're looking for a visual data scientist!_
...
My research focuses on __network analysis and visualization__ for exploring large omics datasets.

I like data. Manipulating it, modeling it, making it (simulation), visualizing it and yes, even cleaning it. I do these things with some combination of __R__, __Python__, and __Javascript__ (d3.js in particular). 
...
When I am not in "school mode" I love to bike places, read science fiction, take photos of birds, and wander around gardens/museums.
